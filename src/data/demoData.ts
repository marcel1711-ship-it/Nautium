...
export const demoVessels: Vessel[] = [
  {
    ...
    photo_url: 'https://images.pexels.com/photos/1118869/pexels-photo-1118869.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    photo_url: 'https://images.pexels.com/photos/163236/luxury-yacht-boat-speed-water-163236.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    photo_url: 'https://images.pexels.com/photos/273886/pexels-photo-273886.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    notes: 'Charter fleet',
    photo_url: 'https://images.pexels.com/photos/1001682/pexels-photo-1001682.jpeg?auto=compress&cs=tinysrgb&w=800',
  ...
  },
  {
    ...
    photo_url: 'https://images.pexels.com/photos/3046637/pexels-photo-3046637.jpeg?auto=compress&cs=tinysrgb&w=800',
...
export const demoEquipment: Equipment[] = [
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000002',
    name: 'Main Engine Port',
    type: 'Engine',
    manufacturer: 'CAT',
    model: 'C32 ACERT',
...
export const demoMaintenanceTasks: MaintenanceTask[] = [
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000001',
    ...
    assigned_user_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    required_parts: [
      { inventory_id: '00000000-0000-0000-0003-000000000001', quantity: 45 },
      { inventory_id: '00000000-0000-0000-0003-000000000002', quantity: 2 }
    ],
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000003',
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000005',
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000002',
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000006',
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000004',
    ...
    assigned_user_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    required_parts: [
      { inventory_id: '00000000-0000-0000-0003-000000000006', quantity: 1 },
      { inventory_id: '00000000-0000-0000-0003-000000000007', quantity: 1 },
      { inventory_id: '00000000-0000-0000-0003-000000000003', quantity: 2 }
    ],
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000002',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000007',
    ...
    assigned_user_id: '00000000-0000-0000-0009-000000000003',
    required_parts: [
  ...
  },
  {
    ...
    vessel_id: '00000000-0000-0000-0001-000000000002',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000008',
    ...
    assigned_user_id: '00000000-0000-0000-0009-000000000003',
    required_parts: [
      { inventory_id: '00000000-0000-0000-0003-000000000009', quantity: 20 },
      { inventory_id: '00000000-0000-0000-0003-000000000010', quantity: 1 }
    ],
    estimated_duration_hours: 3,
...
export const demoInventoryItems: InventoryItem[] = [
  {
    ...
    photo_url: 'https://images.pexels.com/photos/8985454/pexels-photo-8985454.jpeg?auto=compress&cs=tinysrgb&w=400',
  ...
  },
  {
    ...
    photo_url: 'https://images.pexels.com/photos/3807571/pexels-photo-3807571.jpeg?auto=compress&cs=tinysrgb&w=400',
  ...
  },
  {
    ...
    photo_url: 'https://images.pexels.com/photos/4489732/pexels-photo-4489732.jpeg?auto=compress&cs=tinysrgb&w=400',
  ...
  },
  {
    ...
    photo_url: 'https://images.pexels.com/photos/6195121/pexels-photo-6195121.jpeg?auto=compress&cs=tinysrgb&w=400',
  ...
  },
  {
    ...
    photo_url: 'https://images.pexels.com/photos/4239031/pexels-photo-4239031.jpeg?auto=compress&cs=tinysrgb&w=400',
...
export const demoMaintenanceHistory: MaintenanceHistory[] = [
  {
    ...
    completed_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    ...
    photos: [],
    parts_used: [
      { inventory_id: '00000000-0000-0000-0003-000000000006', quantity: 1, name: 'Kohler Generator Oil Filter' }
    ],
  ...
  {
    id: 'hist-4',
    task_id: 'task-completed-4',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000001',
    task_title: 'Main Engine Port - Oil Change',
    due_date: addDays(today, -40),
    completion_date: addDays(today, -38),
    completed_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    completed_by_name: 'Michael Torres',
    completed_by_email: 'chief.engineer@oceanicluxury.com',
    comments: 'Full oil service completed. 45L oil and 2 filters replaced. MTU technician supervised.',
    photos: [],
    parts_used: [
      { inventory_id: '00000000-0000-0000-0003-000000000001', quantity: 45, name: 'MTU Synthetic Engine Oil 15W-40' },
      { inventory_id: '00000000-0000-0000-0003-000000000002', quantity: 2, name: 'MTU Oil Filter' }
    ],
    external_service_cost: 850,
    issues_detected: '',
    created_at: addDays(today, -38) + 'T09:00:00Z'
  },
  {
    id: 'hist-5',
    task_id: 'task-completed-5',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000006',
    task_title: 'HVAC Chiller - Condenser Cleaning',
    due_date: addDays(today, -55),
    completion_date: addDays(today, -53),
    completed_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    completed_by_name: 'Michael Torres',
    completed_by_email: 'chief.engineer@oceanicluxury.com',
    comments: 'Condenser cleaned with 2 kits. No corrosion found. Chiller efficiency restored to 98%.',
    photos: [],
    parts_used: [
      { inventory_id: '00000000-0000-0000-0003-000000000005', quantity: 2, name: 'HVAC Condenser Cleaning Kit' }
    ],
    external_service_cost: 0,
    issues_detected: '',
    created_at: addDays(today, -53) + 'T13:00:00Z'
  },
  {
    id: 'hist-6',
    task_id: 'task-completed-6',
    vessel_id: '00000000-0000-0000-0001-000000000002',
    company_id: '00000000-0000-0000-0000-000000000001',
    equipment_id: '00000000-0000-0000-0002-000000000008',
    task_title: 'Bow Thruster - Annual Service',
    due_date: addDays(today, -70),
    completion_date: addDays(today, -68),
    completed_by_id: '00000000-0000-0000-0009-000000000003',
    completed_by_name: 'Sarah Mitchell',
    completed_by_email: 'engineer2@oceanicluxury.com',
    comments: 'Full annual service by Servogear technician. Hydraulic oil and filter changed. All seals inspected.',
    photos: [],
    parts_used: [
      { inventory_id: '00000000-0000-0000-0003-000000000009', quantity: 20, name: 'Hydraulic Oil ISO 46' },
      { inventory_id: '00000000-0000-0000-0003-000000000010', quantity: 1, name: 'Hydraulic Filter Element' }
    ],
    external_service_cost: 2400,
    issues_detected: '',
    created_at: addDays(today, -68) + 'T10:00:00Z'
  }
];
...
export const demoStockMovements: StockMovement[] = [
  {
    id: 'mov-1',
    inventory_id: '00000000-0000-0000-0003-000000000006',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    movement_type: 'out',
    quantity: -1,
    reason: 'Used in maintenance task: Generator 2 - Oil and Filter Change',
    reference_id: 'hist-1',
    performed_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    performed_by_name: 'Michael Torres',
    created_at: addDays(today, -8) + 'T14:30:00Z'
  },
  {
    id: 'mov-2',
    inventory_id: '00000000-0000-0000-0003-000000000001',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    movement_type: 'in',
    quantity: 60,
  ...
  {
    id: 'mov-3',
    inventory_id: '00000000-0000-0000-0003-000000000002',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    movement_type: 'in',
    quantity: 4,
...
export const demoMaintenanceManuals: MaintenanceManual[] = [
  {
    ...
    file_size: 15728640,
    uploaded_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
...
export const demoFuelLog: FuelLogEntry[] = [
  ...
  { id: 'fl-1', resource_id: 'res-1', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'refill', quantity: 12000, price_per_unit: 0.92, total_cost: 11040, currency: 'EUR', supplier: 'Bunkers Monaco SAM', location: 'Monaco', engine_hours: 4820, notes: 'Pre-crossing top-up', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(30), created_at: subDays(30) + 'T10:00:00Z' },
  { id: 'fl-2', resource_id: 'res-1', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 3800, price_per_unit: null, total_cost: null, currency: 'EUR', supplier: '', location: 'Monaco → Palma', engine_hours: 4868, notes: 'Passage 48h — avg 79 L/h', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(28), created_at: subDays(28) + 'T09:00:00Z' },
  { id: 'fl-3', resource_id: 'res-1', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'refill', quantity: 8000, price_per_unit: 0.89, total_cost: 7120, currency: 'EUR', supplier: 'Repsol Marina Palma', location: 'Palma de Mallorca', engine_hours: 4870, notes: '', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(20), created_at: subDays(20) + 'T14:00:00Z' },
  { id: 'fl-4', resource_id: 'res-1', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 1200, price_per_unit: null, total_cost: null, currency: 'EUR', supplier: '', location: 'Palma — day trips', engine_hours: 4885, notes: '3 day charters', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(15), created_at: subDays(15) + 'T17:00:00Z' },
  { id: 'fl-5', resource_id: 'res-1', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 2500, price_per_unit: null, total_cost: null, currency: 'EUR', supplier: '', location: 'Palma → Ibiza → Palma', engine_hours: 4910, notes: 'Weekend charter round trip', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(8), created_at: subDays(8) + 'T20:00:00Z' },

  // generator diesel
  { id: 'fl-6', resource_id: 'res-2', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'refill', quantity: 3000, price_per_unit: 0.92, total_cost: 2760, currency: 'EUR', supplier: 'Repsol Marina Palma', location: 'Palma de Mallorca', engine_hours: null, notes: 'Same delivery as main diesel', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(20), created_at: subDays(20) + 'T14:30:00Z' },
  { id: 'fl-7', resource_id: 'res-2', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 800, price_per_unit: null, total_cost: null, currency: 'EUR', supplier: '', location: 'At anchor', engine_hours: null, notes: 'Hotel load — 12 days at anchor', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(5), created_at: subDays(5) + 'T08:00:00Z' },

  // fresh water
  { id: 'fl-8', resource_id: 'res-3', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'refill', quantity: 15000, price_per_unit: 0.008, total_cost: 120, currency: 'EUR', supplier: 'Port Authority Palma', location: 'Palma de Mallorca', engine_hours: null, notes: 'Dockside hose connection', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(22), created_at: subDays(22) + 'T09:00:00Z' },
  { id: 'fl-9', resource_id: 'res-3', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 9400, price_per_unit: null, total_cost: null, currency: 'EUR', supplier: '', location: 'On board', engine_hours: null, notes: 'Crew & guests — 22 days consumption', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(3), created_at: subDays(3) + 'T10:00:00Z' },
  { id: 'fl-10', resource_id: 'res-3', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'refill', quantity: 4000, price_per_unit: null, total_cost: null, currency: 'EUR', supplier: 'Watermaker on board', location: 'At sea', engine_hours: null, notes: 'RO watermaker production', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(10), created_at: subDays(10) + 'T12:00:00Z' },

  // engine oil
  { id: 'fl-11', resource_id: 'res-4', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'refill', quantity: 90, price_per_unit: 12.5, total_cost: 1125, currency: 'EUR', supplier: 'MTU Marine Supply', location: 'Palma de Mallorca', engine_hours: 4820, notes: 'After scheduled oil change', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(32), created_at: subDays(32) + 'T11:00:00Z' },
  { id: 'fl-12', resource_id: 'res-4', vessel_id: '00000000-0000-0000-0001-000000000001', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 18, price_per_unit: null, total_cost: null, currency: 'EUR', supplier: '', location: 'Engine room', engine_hours: 4910, notes: 'Top-ups over 3 weeks — slightly above normal', logged_by_id: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334', logged_by_name: 'Michael Torres', log_date: subDays(5), created_at: subDays(5) + 'T09:00:00Z' },

  // vessel-2 main diesel
  { id: 'fl-13', resource_id: 'res-6', vessel_id: '00000000-0000-0000-0001-000000000002', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'refill', quantity: 10000, price_per_unit: 0.91, total_cost: 9100, currency: 'USD', supplier: 'Bunker One Fort Lauderdale', location: 'Fort Lauderdale', engine_hours: 2100, notes: '', logged_by_id: '00000000-0000-0000-0009-000000000003', logged_by_name: 'Sarah Mitchell', log_date: subDays(25), created_at: subDays(25) + 'T13:00:00Z' },
  { id: 'fl-14', resource_id: 'res-6', vessel_id: '00000000-0000-0000-0001-000000000002', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 4000, price_per_unit: null, total_cost: null, currency: 'USD', supplier: '', location: 'Fort Lauderdale → Nassau', engine_hours: 2148, notes: 'Crossing to Bahamas 48h', logged_by_id: '00000000-0000-0000-0009-000000000003', logged_by_name: 'Sarah Mitchell', log_date: subDays(18), created_at: subDays(18) + 'T08:00:00Z' },
  { id: 'fl-15', resource_id: 'res-6', vessel_id: '00000000-0000-0000-0001-000000000002', company_id: '00000000-0000-0000-0000-000000000001', entry_type: 'consumption', quantity: 2000, price_per_unit: null, total_cost: null, currency: 'USD', supplier: '', location: 'Bahamas cruising', engine_hours: 2165, notes: 'Day excursions', logged_by_id: '00000000-0000-0000-0009-000000000003', logged_by_name: 'Sarah Mitchell', log_date: subDays(10), created_at: subDays(10) + 'T17:00:00Z' },
];

export const demoOperationalExpenses: OperationalExpense[] = [
  {
    id: 'opex-1',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'mooring' as OperationalExpenseCategory,
    description: 'Monaco Port Authority — monthly berth fee',
    amount: 4800,
    currency: 'EUR',
    expense_date: subDays(5),
    created_by: 'e4f41f8e-f5bd-484d-b382-a230f4045c71',
    created_at: subDays(5) + 'T09:00:00Z',
  },
  {
    id: 'opex-2',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'electricity' as OperationalExpenseCategory,
    description: 'Shore power — Monaco Marina',
    amount: 620,
    currency: 'EUR',
    expense_date: subDays(5),
    created_by: 'e4f41f8e-f5bd-484d-b382-a230f4045c71',
    created_at: subDays(5) + 'T09:05:00Z',
  },
  {
    id: 'opex-3',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'insurance' as OperationalExpenseCategory,
    description: 'Hull & Machinery quarterly premium — Lloyds',
    amount: 18500,
    currency: 'USD',
    expense_date: subDays(15),
    created_by: 'e4f41f8e-f5bd-484d-b382-a230f4045c71',
    created_at: subDays(15) + 'T10:00:00Z',
  },
  {
    id: 'opex-4',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'port_fees' as OperationalExpenseCategory,
    description: 'Palma de Mallorca port clearance fees',
    amount: 340,
    currency: 'EUR',
    expense_date: subDays(20),
    created_by: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    created_at: subDays(20) + 'T14:00:00Z',
  },
  {
    id: 'opex-5',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'water' as OperationalExpenseCategory,
    description: 'Dockside water connection — Palma Marina',
    amount: 95,
    currency: 'EUR',
    expense_date: subDays(22),
    created_by: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    created_at: subDays(22) + 'T09:30:00Z',
  },
  {
    id: 'opex-6',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'internet' as OperationalExpenseCategory,
    description: 'Starlink maritime monthly plan',
    amount: 250,
    currency: 'USD',
    expense_date: subDays(30),
    created_by: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    created_at: subDays(30) + 'T08:00:00Z',
  },
  {
    id: 'opex-7',
    vessel_id: '00000000-0000-0000-0001-000000000001',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'waste_disposal' as OperationalExpenseCategory,
    description: 'Waste disposal and bilge water treatment — Palma',
    amount: 180,
    currency: 'EUR',
    expense_date: subDays(21),
    created_by: 'e7d4a1b3-1ba9-470d-b419-1da7c0183334',
    created_at: subDays(21) + 'T16:00:00Z',
  },
  {
    id: 'opex-8',
    vessel_id: '00000000-0000-0000-0001-000000000002',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'mooring' as OperationalExpenseCategory,
    description: 'Fort Lauderdale marina monthly berth',
    amount: 3200,
    currency: 'USD',
    expense_date: subDays(10),
    created_by: 'e4f41f8e-f5bd-484d-b382-a230f4045c71',
    created_at: subDays(10) + 'T11:00:00Z',
  },
  {
    id: 'opex-9',
    vessel_id: '00000000-0000-0000-0001-000000000002',
    company_id: '00000000-0000-0000-0000-000000000001',
    category: 'port_fees' as OperationalExpenseCategory,
    description: 'Bahamas customs & cruising permit',
    amount: 450,
    currency: 'USD',
